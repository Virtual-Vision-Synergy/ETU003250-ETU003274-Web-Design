...
(
    ...
    '/uploads/impact-blocked-hormuz-aspera.jpg', 'Vue aérienne du détroit d\'Ormuz avec navires militaires en patrouille',
       ...
       ('Crise humanitaire : deux millions de déplacés en six mois de conflit',
        ...
        principalement dans les provinces du Khuzestan,
        du Kurdistan et du Kermanshah.</p>\n<h2>Conditions de vie précaires dans les camps</h2>\n<p>Les camps de réfugiés établis à la hâte dans les pays voisins — Irak,
        Turquie et Pakistan — peinent à absorber ces flux migratoires massifs. Les organisations humanitaires dénoncent un manque criant d\'eau potable, de nourriture et de soins médicaux.</p>\n<h3>Le drame des populations civiles urbaines</h3>\n<p>Dans les grandes villes comme Ahvaz et Sanandaj, les infrastructures civiles — hôpitaux, réseaux d\'eau et d\'électricité — ont été partiellement détruites par les combats. Médecins Sans Frontières signale une recrudescence de maladies infectieuses dans les zones touchées.</p>\n<h3>L\'aide internationale insuffisante</h3>\n<p>L\'appel humanitaire consolidé des Nations Unies, d\'un montant de 3,
        2 milliards de dollars,
        n\'est financé qu\'à 38 %. Les donateurs traditionnels invoquent des contraintes budgétaires pour justifier leur retrait partiel.</p>\n<h2>Témoignages de survivants</h2>\n<p>Fatima,
        43 ans,
        ...
        '/uploads/syrian-filled-with-hope.jpg',
        'Camp de déplacés dans la région frontalière irano-irakienne avec tentes et familles', 3, 3, 1,
        '2026-03-14 08:15:00'),
       ...
       ('Sanctions économiques : l\'étranglement progressif de l\'économie iranienne',
        ...
        '/uploads/2_Photo-Giovanna-Silva-1400x933.jpg',
...
(
    ...
    '<p>Le conflit iranien met en lumière les contradictions profondes de la politique étrangère russe et chinoise. Ces deux membres permanents du Conseil de Sécurité de l\'ONU opposent systématiquement leur veto aux résolutions les plus contraignantes, tout en cherchant à préserver leurs intérêts économiques dans la région.</p>\n<h2>L\'axe Moscou-Téhéran : une alliance de circonstance</h2>\n<p>La Russie,
        qui a livré des systèmes S-400 à l\'Iran avant le début du conflit, maintient officiellement une position de "neutralité active". En réalité, le Kremlin profite de la diversion iranienne pour réduire la pression internationale sur ses propres aventures militaires.</p>\n<h3>Les intérêts commerciaux russes en jeu</h3>\n<p>Moscou exporte annuellement pour plus de 4 milliards de dollars de bien vers l\'Iran,
        ...
        profitant des prix bradés pratiqués par Téhéran. Simultanément,
        des diplomates chinois conduisent des discussions discrètes avec Washington pour éviter une escalade qui perturberait les routes maritimes vitales pour les exportations chinoises.</p>\n<h2>L\'ONU paralysée</h2>\n<p>Le Conseil de Sécurité a rejeté six résolutions depuis le début du conflit, chacune bloquée par un veto russe ou chinois. Cette paralysie institutionnelle contraint les acteurs occidentaux à agir en dehors du cadre onusien, ce qui fragilise davantage le droit international.</p>',
        '/uploads/Meeting-United-Nations-Security-Council-2014.jpg',
        'Réunion du Conseil de Sécurité des Nations Unies sur le dossier iranien', 2, 5, 1, '2026-03-17 10:45:00'),
       ...
       ('Programme nucléaire iranien : l\'AIEA tire la sonnette d\'alarme',
        ...
        '/uploads/un-resoltution-gaza.jpg',
        'Centrifugeuses d\'enrichissement d\'uranium dans une installation nucléaire iranienne sous surveillance', 3, 1,
        1, '2026-03-18 07:30:00'),
    ...
    '<p>Le Corps des Gardiens de la Révolution islamique (CGRI, ou Pasdaran en persan) joue un rôle central dans la conduite des opérations militaires iraniennes. Cette force paramilitaire d\'élite, forte de 150 000 hommes, dispose de ses propres forces aériennes, navales et terrestres, indépendantes de l\'armée régulière.</p>\n<h2>Organisation et chaîne de commandement</h2>\n<p>Le CGRI est organisé en brigades spécialisées dont la redoutable Force Qods,
        ...
        '/uploads/Iranina-Naval-Strait-of-Hormuz-December-4-2025.jpg',
        'Parade militaire des Gardiens de la Révolution islamique à Téhéran', 1, 2, 1, '2026-03-20 09:00:00'),
    ...
    '<p>Le conflit iranien illustre de manière exemplaire la centralité de la guerre informationnelle dans les conflits modernes. Chaque acteur — Iran,
        ...
        '/uploads/2_Photo-Giovanna-Silva-1400x933.jpg',
        'Journalistes en gilets pare-balles couvrant le conflit depuis une zone sécurisée', 3, 1, 1,
        '2026-03-22 11:00:00'),
...
(
    ...
    '/uploads/syrian-filled-with-hope.jpg', 'Jeunes Iraniens rassemblés dans une rue de Téhéran lors d\'une manifestation silencieuse',
        3, 3, 1, '2026-03-26 08:00:00'),
...
ou un épuisement progressif des belligérants conduisant à un cessez-le-feu fragile. Le deuxième scénario, le moins souhaitable, reste malheureusement le plus probable à court terme selon la majorité des analystes consultés.</p>',
