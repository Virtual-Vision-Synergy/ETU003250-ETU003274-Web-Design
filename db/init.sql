...
<p>Fatima, 43 ans, originaire de Khorramshahr : "En une nuit, nous avons tout perdu. Ma maison, mes souvenirs, mon quartier. Nous marchons depuis cinq jours." Ces récits illustrent la dimension humaine d\'un conflit trop souvent résumé à ses aspects géopolitiques.</p>',
    NULL, 'Camp de déplacés dans la région frontalière irano-irakienne avec tentes et familles', 3, 3, 1, '2026-03-14 08:15:00'
),
...
<p>La classe moyenne iranienne, qui avait émergé dans les années 2000, est aujourd\'hui particulièrement affectée. Le chômage a bondi à 28 % et les universités constatent une fuite des cerveaux sans précédent vers les pays d\'Asie centrale et d\'Europe.</p>',
    NULL, 'Bourse et indicateurs économiques illustrant l\'effondrement du rial iranien', 1, 4, 1, '2026-03-15 14:00:00'
),
...
<p>Le Conseil de Sécurité a rejeté six résolutions depuis le début du conflit, chacune bloquée par un veto russe ou chinois. Cette paralysie institutionnelle contraint les acteurs occidentaux à agir en dehors du cadre onusien, ce qui fragilise davantage le droit international.</p>',
    NULL, 'Réunion du Conseil de Sécurité des Nations Unies sur le dossier iranien', 2, 5, 1, '2026-03-17 10:45:00'
),
...
<p>Face à cette menace, Israël et les États-Unis ont intensifié leurs consultations militaires. Des sources proches du Pentagone évoquent la mise à jour de plans opérationnels pour des frappes chirurgicales contre les sites nucléaires iraniens, similaires à l\'opération "Opera" conduite par Israël en 1981 contre le réacteur irakien Osirak.</p>',
    NULL, 'Centrifugeuses d\'enrichissement d\'uranium dans une installation nucléaire iranienne sous surveillance', 3, 1, 1, '2026-03-18 07:30:00'
),
...
<p>Le Comité de Protection des Journalistes recense 23 journalistes emprisonnés en Iran depuis le début du conflit, et 8 reporters étrangers tués dans des zones de combat. La liberté de la presse, pilier essentiel d\'une couverture équilibrée, subit une pression extrême.</p>',
    NULL, 'Journalistes en gilets pare-balles couvrant le conflit depuis une zone sécurisée', 3, 1, 1, '2026-03-22 11:00:00'
),
...
<p>Navid, 24 ans, étudiant en génie informatique à Ispahan, résume le sentiment de sa génération : "Nous n\'avons pas choisi cette guerre. Nous voulons étudier, travailler, voyager, aimer. Mais chaque jour, le régime et les bombes réduisent notre horizon." Ce sentiment de génération sacrifiée traverse les frontières sociales et géographiques.</p>',
    NULL, 'Jeunes Iraniens rassemblés dans une rue de Téhéran lors d\'une manifestation silencieuse', 3, 3, 1, '2026-03-26 08:00:00'
),
