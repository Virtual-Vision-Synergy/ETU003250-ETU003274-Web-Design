-- ============================================================
-- Iran War News DB — Init Script (CORRIGÉ)
-- ============================================================
SET NAMES utf8mb4;
...
('Politique & Diplomatie', 'politique-diplomatie',      'Analyses des enjeux politiques et diplomatiques autour du conflit iranien.'),
...
-- Seed: Articles
-- ============================================================
INSERT INTO articles (title, slug, summary, content, image, image_alt, author_id, category_id, is_published, published_at) VALUES

(
    'Les négociations diplomatiques au bord de l\'impasse : vers une escalade inévitable ?',
...
(
    ...
    '<p>Le Corps des Gardiens de la Révolution islamique (CGRI, ou Pasdaran en persan) joue un rôle central dans la conduite des opérations militaires iraniennes. Cette force paramilitaire d\'élite, forte de 150 000 hommes, dispose de ses propres forces aériennes, navales et terrestres, indépendantes de l\'armée régulière.</p>\n<h2>Organisation et chaîne de commandement</h2>\n<p>Le CGRI est organisé en brigades spécialisées dont la redoutable Force Qods, chargée des opérations extérieures. C\'est cette unité qui coordonne le soutien aux mandataires régionaux — Hezbollah au Liban, factions armées en Irak, Houthis au Yémen et Hamas en Palestine.</p>\n<h3>Capacités en matière de drones et missiles</h3>\n<p>L\'investissement massif du CGRI dans les technologies de drones et de missiles balistiques a transformé la doctrine militaire iranienne. Les missiles Fattah-2, hypersoniques, représentent une menace crédible contre les systèmes de défense antimissile actuels, avec une portée déclarée de 1 400 kilomètres.</p>\n<h3>Le réseau de mandataires comme multiplicateur de force</h3>\n<p>La stratégie de "résistance" du CGRI repose sur l\'activation coordonnée de ses mandataires pour ouvrir plusieurs fronts simultanément. Cette approche place l\'adversaire face à des menaces dispersées, difficiles à contrer avec des moyens conventionnels.</p>\n<h2>Financement et économie de guerre</h2>\n<p>Le CGRI contrôle un empire économique estimé à 20 % du PIB iranien, couvrant les télécommunications, la construction et le pétrole. Ces ressources lui permettent de maintenir son effort de guerre indépendamment des contraintes budgétaires de l\'État.</p>',
    '/uploads/Iranina-Naval-Strait-of-Hormuz-December-4-2025.jpg', 'Parade militaire des Gardiens de la Révolution islamique à Téhéran', 1, 2, 1, '2026-03-20 09:00:00'
),
...
(
    ...
    '<p>Le conflit iranien illustre de manière exemplaire la centralité de la guerre informationnelle dans les conflits modernes. Chaque acteur — Iran, États-Unis, Israël, puissances européennes — déploie des instruments sophistiqués pour façonner la perception internationale des événements.</p>\n<h2>L\'arsenal médiatique iranien</h2>\n<p>La chaîne Press TV, bien que bloquée dans de nombreux pays, continue de diffuser sur internet avec des audiences significatives en Amérique latine et en Afrique. Les Gardiens de la Révolution ont également développé des capacités avancées de cyberguerre et de désinformation sur les réseaux sociaux.</p>\n<h3>Les narratives occidentales</h3>\n<p>Les médias occidentaux, pour leur part, couvrent abondamment les violations des droits de l\'homme en Iran et les ambitions nucléaires iraniennes, tout en minimisant systématiquement les conséquences des sanctions sur la population civile, dénonce l\'ONG Reporters Sans Frontières.</p>\n<h3>Le rôle amplificateur des réseaux sociaux</h3>\n<p>X (anciennement Twitter), Telegram et TikTok jouent un rôle sans précédent dans la diffusion d\'informations — et de désinformations — concernant le conflit. Des études récentes révèlent que 68 % des vidéos virales relatives au conflit contiennent des éléments trompeurs ou hors contexte.</p>\n<h2>Journalistes sous pression</h2>\n<p>Le Comité de Protection des Journalistes recense 23 journalistes emprisonnés en Iran depuis le début du conflit, et 8 reporters étrangers tués dans des zones de combat. La liberté de la presse, pilier essentiel d\'une couverture équilibrée, subit une pression extrême.</p>',
    '/uploads/2_Photo-Giovanna-Silva-1400x933.jpg', 'Journalistes en gilets pare-balles couvrant le conflit depuis une zone sécurisée', 3, 1, 1, '2026-03-22 11:00:00'
),
...
(
    ...
    '<p>Six mois se sont écoulés depuis que le conflit a basculé dans une phase ouverte. Le moment est venu de dresser un bilan lucide et d\'examiner les scénarios envisageables pour une sortie de crise.</p>\n<h2>Bilan humain et matériel</h2>\n<p>Les pertes militaires cumulées des différentes parties dépassent 12 000 combattants, selon les estimations croisées de plusieurs instituts de recherche stratégique. Les victimes civiles sont difficiles à chiffrer avec précision, mais le Comité International de la Croix-Rouge estime à plus de 45 000 le nombre de civils tués ou grièvement blessés.</p>\n<h3>Destruction des infrastructures</h3>\n<p>Les dommages aux infrastructures iraniennes — réseaux énergétiques, systèmes de distribution d\'eau, hôpitaux — sont évalués à 180 milliards de dollars par la Banque mondiale. La reconstruction prendra des décennies et nécessitera un accompagnement international massif.</p>\n<h3>Impact économique régional</h3>\n<p>Le prix du baril de Brent oscille entre 130 et 160 dollars, alimentant l\'inflation en Europe et en Asie. Les économies importatrices de pétrole enregistrent des récessions techniques, élargissant le conflit à une dimension économique mondiale.</p>\n<h2>Scénarios de sortie de crise</h2>\n<p>Les experts identifient trois scénarios principaux : un accord négocié sous pression internationale incluant un moratoire nucléaire iranien en échange d\'une levée partielle des sanctions ; une escalade jusqu\'à un conflit régional généralisé ; ou un épuisement progressif des belligérants conduisant à un cessez-le-feu fragile. Le deuxième scénario, le moins souhaitable, reste malheureusement le plus probable à court terme selon la majorité des analystes consultés.</p>',
    '/uploads/united-nations-geneva-conference-room-49495178.jpg', 'Ruines d\'un quartier touché par les combats dans une ville iranienne avec équipes de secours', 2, 1, 1, '2026-03-28 10:00:00'
);
